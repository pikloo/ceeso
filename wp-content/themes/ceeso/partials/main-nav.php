...
<nav class="relative px-4 xl:px-0 py-1 flex justify-between items-center xl:max-w-screen-xl mx-auto">
    ...
    <div class="navbar-regular hidden absolute top-1/2 left-[30%] transform -translate-y-1/2 -translate-x-1/2 xl:flex xl:mx-auto xl:flex xl:items-center xl:w-auto xl:space-x-2">
        <?= $menu_main; ?>
    </div>
