<section class="bg-secondary text-white p-4 relative">
    <div class="absolute xl:bg-start bg-auto left-[43%] top-[10%] h-[454px] w-full bg-no-repeat z-50"></div>
    <div class="max-w-screen-sm lg:max-w-screen-xl mx-auto lg:flex lg:flex-row-reverse lg:gap-x-10 relative z-50">
        ...
        <div class="space-y-8 lg:w-1/2 lg:py-10 xl:py-20">
            ...
            <div class="w-full xl:flex xl:gap-x-4 xl:items-center">
                <a class="button bg-primary mb-2.5 xl:mb-0 xl:w-max px-5 hover:bg-primary/80" href="">S'inscrire à la JPO</a>
                <a class="button border border-white xl:w-max px-5" href="">
