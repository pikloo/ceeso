<section class="bg-secondary text-white p-4 lg:p-10 xl:py-20">
    <div class="max-w-screen-xl mx-auto lg:flex lg:flex-row-reverse">
        ...
        <div class="space-y-8 lg:w-1/2">
            ...
            <div class="w-full xl:flex xl:gap-x-4 xl:items-center">
                <a class="button bg-primary mb-2.5 xl:mb-0 w-1/2" href="">S'inscrire à la JPO</a>
                <a class="button border border-white w-1/2" href="">
