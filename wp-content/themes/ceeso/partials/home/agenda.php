    ...
    <div class="border-[0.3px] border-primary rounded divide-y divide-primary flex flex-col lg:flex-row lg:divide-x lg:divide-y-0">
        ...
        <?php while ($loop->have_posts()) : ?>
            ...
            <div class="p-4 lg:w-1/3">
                ...
                <a aria-role=”button” aria-label="<?php the_title(); ?>" href=<?= get_the_permalink() ?> class="group text-primary hover:text-secondary flex items-center  mb-4" href=""><span class="mr-3">Découvrir</span> <svg class="transition transform group-hover:translate-x-2" width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
